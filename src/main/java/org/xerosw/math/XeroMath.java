...
/**
 * A set of general math functions.
 */
public class XeroMath {

    /**
     * Normalize an angle in degrees.
     * Converts the input angle to an angle between -180 and +180 degrees.
     * @param a The input angle in degrees.
     * @return The input angle normalized between -180 and +180 degrees.
     */
     ...
     * Converts the input angle to an angle between -PI and +PI radians.
     * @param a The input angle in radians.
     * @return The input angle normalized between -PI and +PI radians.
     */
